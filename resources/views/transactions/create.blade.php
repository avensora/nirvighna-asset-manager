@extends('layouts.app', ['title' => 'Add Transaction', 'subtitle' => 'Finances'])
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="reference" class="form-control @error('reference') is-invalid @enderror"
                               value="{{ old('reference') }}" placeholder="e.g. INV-2026-0001, receipt #">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="3" class="form-control @error('description') is-invalid @enderror"
                                  placeholder="Any notes about this transaction">{{ old('description') }}</textarea>
